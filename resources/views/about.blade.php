...
<!-- Tentang Kami -->
<!-- Tentang Kami -->
<div class="container my-5 pt-5" id="tentang">
  <div class="text-center mb-4">
    <h2 class="fw-bold">Our Story</h2>
    <p class="text-white-50">
      Tim kami terdiri dari para ahli yang berdedikasi dan berpengalaman dalam berbagai disiplin ilmu teknologi, manajemen proyek, dan analisis.
      Keberagaman latar belakang ini memungkinkan kami untuk dapat memberikan layanan teknologi yang unggul kepada klien.
    </p>
  </div>

  <div class="row g-3">
    <div class="col-md-4 col-sm-6">
      <img src="https://www.lawencon.com/wp-content/uploads/2024/07/Page-1.webp" class="img-fluid rounded shadow" alt="Foto 1">
    </div>
    <div class="col-md-4 col-sm-6">
      <img src="https://www.lawencon.com/wp-content/uploads/2024/07/Page-3.webp" class="img-fluid rounded shadow" alt="Foto 2">
    </div>
    <div class="col-md-4 col-sm-6">
      <img src="https://www.lawencon.com/wp-content/uploads/2024/07/Page-2.webp" class="img-fluid rounded shadow" alt="Foto 3">
    </div>
    <div class="col-md-4 col-sm-6">
      <img src="https://www.lawencon.com/wp-content/uploads/2024/07/Page-4.webp" class="img-fluid rounded shadow" alt="Foto 4">
    </div>
    <div class="col-md-4 col-sm-6">
      <img src="https://www.lawencon.com/wp-content/uploads/2024/07/Page-5.webp" class="img-fluid rounded shadow" alt="Foto 5">
    </div>
  </div>
</div>
